...
st.write("Upload the required files and trigger reconciliation.")
...
process_button = st.button("Run Reconciliation")

if process_button and all([kcb_file, equity_file, aspire_file, key_file]):
    ...
    # Continue with processing (original script goes below)
# -*- coding: utf-8 -*-
"""Cards.ipynb
...
Original file is located at
    https://colab.research.google.com/drive/1mzoyHJS5Iuf5ZDfKaABk6mL1Ys9dM4rM
...
kcb = pd.read_excel("kcb")
equity = pd.read_excel("equity")
aspire = pd.read_csv("aspire")
...
aspire = pd.read_csv('aspire')
merged_cards = pd.read_excel('merged_cards')
...
merged_cards.to_excel("merged_cards", index=False)
